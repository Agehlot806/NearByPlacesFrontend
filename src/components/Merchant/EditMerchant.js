...
function Allstoresedit() {
  ...
  useEffect(() => {
    ...
    fetch(
      `https://nearbyplaceadminpanner.onrender.com/api/v1/allstores/${_id}`,
      requestOptions
    )
      .then((response) => response.json())
      .then((data) => {
        console.log("datatarun", data);
        setStores(data.store);
        setName(data.stores.name);
        setPhoneNumber(data.stores.phonenumber);
        // setCategories(data.stores.category.categoryname)
        setStorePhoto(data.stores.storephoto);
        setWebsite(data.stores.website);
        setStoregallery(data.stores.storegallery);
        setRatings(data.stores.ratings);
        setReviews(data.stores.reviews);
        setLatitude(data.stores.latitude);
        setLongitude(data.stores.longitude);
        setOwnerName(data.stores.storeownername);
        setImageTrue(true);
  ...
  const allCategorys = () => {
    fetch(`https://nearbyplaceadminpanner.onrender.com/api/v1/allcategory`)
      ...
      .then((response) => {
        ...
        setDropcategory(response.category);
      })
      .catch((error) => {
  ...
  //     formData.append('storegallery', storegallery);
  //     axios({
  //         method: "put",
  //         url: `https://nearbyplaceadminpanner.onrender.com/api/v1/stores/${_id}`,
  //         data: formData,
  ...
  const UpdateStoreDetail = (e) => {
    ...
    formData.append("storeownername", ownerName);
                    ...
                    <div className="tab-content" id="nav-tabContent">
                        ...
                        <Form onSubmit={UpdateStoreDetail}>
                          ...
                          <div className="form-row">
                            <div className="form-group col-md-6">
                              ...
                              {/* <select id="inputState" onChange={(e) => handleCategories(e)} className="form-control">
                              ...
                              {/* <label>Category :</label>
                                                            <Input type="text" className="form-control"
                                                                placeholder="Enter..."
                                                                value={categories} onChange={(e) => handleCategories(e)} 
                                                            /> */}
                            </div>
                            <div className="form-group col-md-6">
                              <label>WebSite </label>
                      ...
                      >
                        <div className="form-row image-size">
                          ...
                          <div className="form-group col-md-6">
                            <label>
                              <i class="mdi mdi-image-album" /> Store gallery
                            </label>
                            <Input
                              type="file"
                              className="form-control"
                            ...
                            <img
                              src={galleryImage ? storegallery : filegallery}
                              alt="gallery"
                            />
                          </div>
                        </div>
                      ...
                      >
                        ...
                        <p className="text-blue">
                          Services are grouped together, a group can have one
                          choice or multiple choices, you can attach each
                          service with a small description if necessary
                        </p>
                        <button
                          type="button"
                        ...
                        >
                          <i className="mdi mdi-playlist-check" /> Create new
                          services group
                        </button>
