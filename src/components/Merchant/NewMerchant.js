...
function Storeaddnew() {
  ...
  const [website, setSebsite] = useState("");
  ...
  const [imagePhoto, setImagePhoto] = useState(false);
  ...
  const storeaddpage = async (e) => {
    ...
    formData.append("subscriptionPlanId", subscription);
    formData.append("storephoto", storephotofiles);
    formData.append("storegallery", fileData);
    ...
    axios({
      ...
      url: `https://nearbyplaceadminpanner.onrender.com/api/v1/addnewstore/${selectedCategory}/stores`,
      //   url: `https://nearbyplaceadminpanner.onrender.com/api/v1/addnewstore/${selectedCategory}/stores`,
      data: formData,
  ...
  const handleStorephotofiles = (event) => {
    setImagePhoto(true);
  ...
  const allSubcription = () => {
    fetch(
      `https://nearbyplaceadminpanner.onrender.com/api/v1/getallsubscription`
    )
      .then((res) => res.json())
      .then((responsive) => {
        console.log("allsubscriptionm", responsive);
        setSubscriptionData(responsive.subscription);
        // setStorecount(responsive.storeCount)
      })
      .catch((error) => {
        console.log("error", error);
                    ...
                    <div className="tab-content" id="nav-tabContent">
                      ...
                      >
                        <form onSubmit={storeaddpage}>
                          ...
                          <div className="form-row">
                            <div className="form-group col-md-6">
                              <label htmlFor="inputState">Subscription :</label>
                              <select
                                id="inputState"
                                className="form-control"
                              ...
                              >
                                ...
                                {subscriptionData &&
                                  subscriptionData.map((categorys) => (
                                    <option
                                      value={categorys._id}
                                      key={categorys._id}
                                    >
                            ...
                            <div className="form-group col-md-6">
                              ...
                              <Input
                                ...
                                placeholder="Enter..."
                                value={website}
                                onChange={(e) => setSebsite(e.target.value)}
                              />
                            </div>
                          </div>
                          <div className="form-row">
                        ...
                        <div className="form-row image-size">
                          <div className="form-group col-md-6">
                            ...
                            <Input
                              ...
                              className="form-control"
                              placeholder="Enter..."
                              // value={storephotofiles}
                              onChange={handleStorephotofiles}
                            />
                            {imagePhoto ? (
                          ...
                          <div className="form-group col-md-6">
                            ...
                            <Input
                              ...
                              placeholder="Enter..."
                            />
                            {imageTrue ? <img src={file} alt="file"></img> : ""}
                          </div>
                        </div>
                        {/* <div className='user-head'>
                              ...
                              {storeData &&
                                storeData.map((items, index) => (
                                  <tr key={index}>
                                    ...
                                    <td>{items.ratings}</td>
                                    <td className="click-color">
                                      <a href="review">{items.numOfReviews}</a>
                                    </td>
                                    <td>
                                      <Link to={`/book-table/${items._id}`}>
