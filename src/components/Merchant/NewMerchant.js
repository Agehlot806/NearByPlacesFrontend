...
function Storeaddnew() {
    ...
    const storeaddpage = async (e) => {
        ...
        formData.append('category', selectedCountry);
        formData.append('address', address);
        formData.append('website', website);
        formData.append("phonenumber", phonenumber);
        formData.append('storephotofiles', storephotofiles);
        formData.append('storegalleryfiles', fileData);
        ...
        axios({
            ...
            url: "https://nearbyplaceadminpanner.onrender.com/api/v1/addnewstore",
            data: formData,
                                                ...
                                                <form onSubmit={storeaddpage}>
                                                    ...
                                                    <div className="form-row">
                                                        ...
                                                        <div className="form-group col-md-6">
                                                            ...
                                                            <Input type="text" className="form-control"
                                                                placeholder="Enter..."
                                                                value={website} onChange={(e) => setSebsite(e.target.value)} />
                                                        </div>
                                                    </div>
                                                    <div className="form-row">
                                                        <div className="form-group col-md-6">
