...
function Eventedit() {
  ...
  const UpdateEventDetail = (e) => {
    ...
    axios
      .put(
        `https://nearbyplaceadminpanner.onrender.com/api/v1/events/${_id}`,
        formData,
        {
  ...
  const EditEvent = async () => {
    ...
    await fetch(
      ...
      .then((data) => {
        ...
        setFile(data.event.eventimage);
        setPhonenumber(data.event.phonenumber);
                    ...
                    <div className="row">
                      <div className="col-sm-12">
                        <div className="product-list-box">
                          <div className="product-list-box-header">
                            <h3>
                              <b>Drag the marker to get the exact position :</b>
                            </h3>
                          </div>
                          <div className="product-card-body">
                            <div className="form-group">
