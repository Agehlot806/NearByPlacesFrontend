...
import CategoryEdit from "./components/Application/Categories/categories-edit";
import Categorys from "./components/Merchant/categorys";
import Paynowp from "./components/My bookings/paynowp";
import PaymentSuccess from "./components/My bookings/paymentsuccess";
import Alluser from "./components/Coustomer User/alluser";
import Myuser from "./components/Coustomer User/myuser";
import Adduser from "./components/Coustomer User/adduser";
import Access from "./components/Manage Users/access";
import RadioComponent from "./components/Manage Users/demouser";
    ...
    <>
      <Router>
        <Switch>
          ...
          <Route exact path="/storecategory/:_id" component={Categorys} />
          ...
          <Route exact path="/paynow/:id" component={Paynowp} />
          ...
          <Route exact path="/categoryedit/:_id" component={CategoryEdit} />
          <Route exact path="/all-user" component={Alluser} />
          <Route exact path="/my-user" component={Myuser} />
          <Route exact path="/user-new-add" component={Adduser} />
          <Route exact path="/useraccess/:id" component={Access} />
          <Route exact path="/RadioComponent" component={RadioComponent} />
        </Switch>
      </Router>
    </>
  );
